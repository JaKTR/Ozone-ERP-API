...
AZURE_STORAGE_PUBLIC_CONTAINER_NAME: str = f"umbrella-erp-api-{ENVIRONMENT.lower()}-public"
PUBLIC_KEY_FILE_NAME: str = f"umbrella-public-key-{ENVIRONMENT.lower()}.pub"